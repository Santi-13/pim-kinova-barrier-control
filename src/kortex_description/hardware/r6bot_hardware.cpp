...
#include "kortex_description/r6bot_hardware.hpp"
#include <string>
#include <vector>

namespace kortex_description
{
...
{
  std::vector<hardware_interface::StateInterface> state_interfaces; // Local vector
...
{
  std::vector<hardware_interface::CommandInterface> command_interfaces; // Local vector
...
{
  // Remove this block to avoid overwriting positions:
  // for (auto i = 0ul; i < joint_position_command_.size(); i++)
  // {
  //   joint_position_[i] = joint_position_command_[i];
  // }

  // Keep velocity integration:
...
{
  // No need to manually copy values from command interfaces.
  // The framework already updates joint_velocities_command_ automatically.
  // Add logic here if you need to send commands to actual hardware.
  return return_type::OK;
}
...
PLUGINLIB_EXPORT_CLASS(
  kortex_description::RobotSystem, hardware_interface::SystemInterface)
