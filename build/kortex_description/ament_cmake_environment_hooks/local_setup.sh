...
: ${AMENT_CURRENT_PREFIX:="/home/sanmaster/pim-kinova/install/kortex_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kortex_description/environment/library_path.sh"
